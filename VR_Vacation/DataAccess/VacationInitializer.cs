    ...
    public class VacationInitializer : System.Data.Entity.DropCreateDatabaseIfModelChanges<VacationContext>
    {
        protected override void Seed(VacationContext context)
        {
            ...
            var packages = new List<Package>
            {
                new Package
                {
                    Name= "Glorious Glaciers and Northern Lights", Description = "Winter in Iceland is hard to beat for magical landscape. From icy lava fields to " +
                      ...
                      "Northern Lights road trip.", Price = 2300.00,
                    ImagePath = "https://42j2u214fxk4e2pss1rw1xf1-wpengine.netdna-ssl.com/wp-content/uploads/2018/07/Jokuls%C3%A1rlon-768x510.jpg", DestinationId = 1
                },
                new Package
                {
                    Name= "Nature’s Treasures and Northern Lights", Description = "Experience West Iceland’s rich history and mystical landscape on the great Nature’s" +
                     " Treasures and Northern Lights guided tour.", Price = 2000.00,
                    ImagePath = "https://42j2u214fxk4e2pss1rw1xf1-wpengine.netdna-ssl.com/wp-content/uploads/2018/03/glacial-lagoon-and-south-shore-4-768x513.jpg",
                    DestinationId = 1
                },
                new Package
                {
                    Name= "Reykjavik and Golden Circle Road Trip", Description = "Looking for a budget friendly short getaway in Iceland? This great value tour" +
                     ...
                     " 4 days.", Price = 1500.00,
                    ImagePath = "https://42j2u214fxk4e2pss1rw1xf1-wpengine.netdna-ssl.com/wp-content/uploads/2018/04/golden-circle-and-glacier-10-768x509.jpg",
                    DestinationId = 1
                },
                new Package
                {
                    Name= "Dive & Cruise in Fakarava", Description = "Cruising aboard the Aqua Tiki II is perfect for divers (and non-divers) who wish to enjoy" +
                      " preserved and secluded atolls.", Price = 1700.00,
                    ImagePath = "https://www.telegraph.co.uk/content/dam/Travel/leadAssets/32/70/tahiti-bora_3270899a.jpg?imwidth=450", DestinationId = 2
                },
                new Package
                {
                    Name= "Bora Bora and Taha'a", Description = "This 9-day island escape takes you to premium resorts on the islands of Bora Bora and Taha'a.",
                    Price = 1800.00, ImagePath = "https://lonelyplanetwpnews.imgix.net/2018/02/GettyRF_177387658-e1518014145130.jpg", DestinationId = 2
                },
                new Package
                {
                    Name= "Island Hopper", Description = "This 12-day vacation takes you to Moorea, Bora Bora, and Tahiti in the islands of French Polynesia.",
                    Price = 2300.00, ImagePath = "https://www.tahitilegends.com/images/about_us.jpg", DestinationId = 2
                }
            };
            ...
            var experiences = new List<Experience>
            {
                new Experience
                {
                    ...
                    Price = 220.00, ImagePath = "temp", PackageId = 1
                },
                new Experience
                {
                    ...
                    "roofed buildings.'",
                    Price = 150.00, ImagePath = "temp", PackageId = 1
                },
                new Experience
                {
                    ...
                    Price = 200.00, ImagePath = "temp", PackageId = 1
                },
                new Experience
                {
                    ...
                    Price = 180.00, ImagePath = "temp", PackageId = 2
                },
                new Experience
                {
                    ...
                    Price = 210.00, ImagePath = "temp",  PackageId = 2
                },
                new Experience
                {
                    ...
                    Price = 1590.00, ImagePath = "temp", PackageId = 2
                },
                new Experience
                {
                    ...
                    Price = 130.00, ImagePath = "temp",  PackageId = 3
                },                new Experience
                {
                    ...
                    Price = 170.00, ImagePath = "temp",  PackageId = 3
                },
                new Experience
                {
                    ...
                    Price = 150.00, ImagePath = "temp",  PackageId = 4
                },
                new Experience
                {
                    ...
                    Price = 185.00, ImagePath = "temp", PackageId = 4
                },
                new Experience
                {
                    ...
                    Price = 190.00, ImagePath = "temp",  PackageId = 4
                },
                new Experience
                {
                    ...
                    Price = 155.00, ImagePath = "temp",  PackageId = 5
                },
                new Experience
                {
                    ...
                    Price = 215.00, ImagePath = "temp", PackageId = 5
                },
                new Experience
                {
                    ...
                    Price = 180.00, ImagePath = "temp",  PackageId = 5
                },
                new Experience
                {
                    ...
                    Price = 190.00, ImagePath = "temp", PackageId = 6
                },
                new Experience
                {
                    ...
                    Price = 350.00, ImagePath = "temp", PackageId = 6
                },
                new Experience
                {
                    ...
                    Price = 330.00, ImagePath = "temp", PackageId = 6
                }
                        ...
                        var users = new List<User>
            {
                new User
                {
                    Username = "freddy",Password = "123Fred",Firstname = "Fred",Lastname = "Jones",
                    EmailAddress = "fred@email.com", PhoneNumber = "111-111", Address = "Street 1",
                },
                new User
                {
                    Username = "sara56",Password = "pass123",Firstname = "Sara",Lastname = "Connor",
                    EmailAddress = "sara@email.com", PhoneNumber = "222-222", Address = "Street 2"

                },
                new User
                {
                    Username = "samIam",Password = "password",Firstname = "Sam",Lastname = "Smith",
                    EmailAddress = "sam@email.com", PhoneNumber = "333-333", Address = "Street 3",
                }
            };
            ...
            var orders = new List<Order>
            {
                new Order
                {
                    Total = 2600.00, IsPaid = false, UserId = 1
                }
            };
            ...
            var test = context.Orders.Find(1);
            test.Experiences = new List<Experience>
            {
                new Experience
                {
                    Name = "Papeete: Le Meridien Tahiti",
                    Description = "Located 10 minutes from the airport and 15 minutes from downtown, this completely" +
                              " renovated 41/2 star resort offers 138 rooms and suites as well as 12 polynesian styled overwater bungalows.",
                    Price = 330.00,
                    ImagePath = "temp",
                    PackageId = 6
